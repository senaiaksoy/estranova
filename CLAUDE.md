...
- Yayınlanan makalede bu bölüm görünmez taslak olarak kalamaz; **görünür FAQ bloğuna** dönüşmeli ve aynı soru-cevaplar `FAQPage` structured data içinde de yer almalıdır.
...
- [ ] **FAQ:** `pratik_veya_sss` 3–5 konuya özgü soru; jenerik meta soru yok (§3 + Writer doğrulaması). Yayınlanan sayfada görünür FAQ bloğu var ve schema ile aynı içeriği taşıyor.
