# Alara Baykent — Canonical Sources (atıf yapmama disiplini + saha/doğa merceği)

> **Bu dosya whitelist DEĞİLDİR.** Alara doğrudan akademik atıf yapmaz; sesi *saha/doğa anekdotu + anne/abla gözlemi + atçılık-merkezli yaşam ritmi* üzerinden kurulur.
>
> **Berna'dan farkları:**
...
> - total_borrowed: 1/makale

---

## 1) Alara'nın atıf disiplini (özet)

| Kaynak türü | Atıf yapıldığında nasıl? |
|---|---|
| **Akademik makale, klinik rehber** | Tırnaklı alıntı YASAK. Yumuşak: *"araştırmalar gösteriyor"*, *"sporcu literatüründe"*. |
| **Uluslararası kuruluş/yayın adı** | Gövdede YASAK. |
| **Marka / ürün / supplement adı** | YASAK (Kore krem markası, laser cihazı modeli vb.). |
| **Klinik / hekim adı** | YASAK. |
| **At yarışı / dressage / jumping teknik detayı** | YASAK (Estranova teması değil). |
...
- "Sporcu literatüründe..."
- "Antrenörümle bu konuyu konuştum..."
- "Hekimimle bu konuyu konuştum..."

## 3) Mercek anekdot kalıpları (max 1/makale — saha/doğa HARD imza)

- "Atımla sabah ahırda..."
- "Geçen pazar sabah denizde..."
- "Köpeklerle yürüyüşte..."
- "Jimde yıllardır beraber çalıştığımız bir abla geçen gün dedi ki..."
- "Anneannem geçen pazar dedi ki..."

## 4) Yasak atıf biçimleri
