# Gamze Cizreli — Pending Citations (editör onay kuyruğu)
...
>
> **AI agent için kural:** `pending.md`'deki adaylar makale yazımında **kullanılmaz**; yalnız `extended.md` ve korpus kullanılır. Bu dosya editör süreci içindir.
...
```markdown
### [PENDING] [Yazar Adı] — [Eser Adı], s.[Sayfa]

> *"Birebir alıntı tırnak içinde."*

- **Önerildiği makale:** [slug + tarih]
- **Atıf etiketi:** [GC ↦ Yazar]
- **Atıf üslubu:** "[Cizreli kalıbı]"
- **Eser kanonik kaynağı:** [yayınevi, çevirmen]
- **Doğrulayan kaynaklar (≥2):** [URL/kaynak 1] · [URL/kaynak 2]
- **Önerme bağlamı:** [hangi paragraf, neden bu cümle seçildi]
- **Doktrin filtresi (tasavvuf için):** [kültürel metafor mu, dini hüküm mü, AI ön-eleme sonucu]
...
> _Henüz hiçbir aday önerilmedi. İlk pilot makale (Tuz/Su/Ter veya başka konu) sonrası AI buraya yazmaya başlayacak._
