# Gamze Cizreli — Extended Citations (onaylı genişleme havuzu)
...
- **Atıf etiketi:** [GC ↦ Yazar] (Gamze'nin korpus dışı, ama hattındaki yazardan)
- **Atıf üslubu:** "[Cizreli kalıbı, örn. 'Fransız yazar Anaïs Nin'in dediği gibi']"
...
- **Doktrin filtresi:** [tasavvuf yazarları için: kültürel metafor mu, dini hüküm mü]
...
- Son güncelleme: 2026-04-29 (modüler dönüşüm — başlangıç)
